...
const SEC: React.CSSProperties = {
  ...
  letterSpacing: 2, textTransform: 'uppercase', color: C.amber, marginBottom: 6,
};
    ...
    <div id="print-recipe" style={{ display: 'none' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          paddingBottom: 8, borderBottom: `2px solid ${C.amber}`,
        }}>
        ...
        {/* ══ 5 CARDS DE MÉTRICAS ══════════════════════════════════ */}
        <div style={{ flex: '0 0 auto', display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 5 }}>
          {[
        ...
        <div style={{ flex: 2, minHeight: 0, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 5 }}>
          ...
          <div style={CARD}>
            ...
            {hopRows.length === 0
              ...
              : hopRows.map((h, i) => (
                <div key={i} style={{
                  display: 'flex', alignItems: 'flex-start', gap: 5, marginBottom: 5,
          ...
          {hasSalts && waterTarget && (
            <div style={{ ...CARD, background: C.bgWater, borderColor: C.bWater }}>
              ...
              {IONS.map(({ key, label }) => {
                ...
                const ok = ionOk(v, r);
                return (
                  <div key={key} style={{ display: 'flex', alignItems: 'center', gap: 3, marginBottom: 2.5 }}>
        ...
        <div style={{ flex: '0 0 auto' }}>
          <div style={{ fontFamily: mono, fontSize: 7, color: C.inkDim, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 5 }}>
            📝 Notas do Dia
          </div>
          {[...Array(5)].map((_, i) => (
            <div key={i} style={{ borderBottom: `1px solid ${C.b2}`, height: 15, marginBottom: 8 }} />
          ))}
        </div>
        ...
        <div style={{
          flex: '0 0 auto',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          paddingTop: 5, borderTop: `1px solid ${C.b1}`,
        }}>
